...
function job() {
  ...
  python3 -m src.scripts.main -c config/config_cvib_supervised.py \
    ...
    --model.arch_file src/arch/adult/adult_cvib_supervised.py \
...
#export -f job
#parallel -j10 job {1} {2} {3} ::: 1e-2 2e-2 3e-2 4e-2 5e-2 6e-2 7e-2 8e-2 9e-2 1e-1 2e-1 3e-1 4e-1 5e-1 6e-1 7e-1 8e-1 9e-1 1e0 ::: 1e-3 ::: cuda:0
#parallel -j10 job {1} {2} {3} ::: 1e-2 2e-2 3e-2 4e-2 5e-2 6e-2 7e-2 8e-2 9e-2 1e-1 2e-1 3e-1 4e-1 5e-1 6e-1 7e-1 8e-1 9e-1 1e0 ::: 1e-1 ::: cuda:0
#parallel -j10 job {1} {2} {3} ::: 1e-2 2e-2 3e-2 4e-2 5e-2 6e-2 7e-2 8e-2 9e-2 1e-1 2e-1 3e-1 4e-1 5e-1 6e-1 7e-1 8e-1 9e-1 1e0 ::: 1e-2 ::: cuda:0
